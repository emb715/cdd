...
### Fixed
- Include `.claude/` directory in published npm package
  - Previous version excluded dotfiles, causing `npx @emb715/cdd init` to fail
  - Added `!.claude/` to .npmignore to force inclusion
...
[0.1.2]: https://github.com/emb715/cdd/releases/tag/v0.1.2
