...
This directory contains example work items demonstrating the CDD v1.0 methodology.
...
When running `/create-work`, refer to these examples to see what good documentation looks like.
...
**CDD v1.0** - More examples will be added as the methodology evolves.
